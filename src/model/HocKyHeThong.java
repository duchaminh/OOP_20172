...
/*=================== ATTRIBUTEs ==================================*/
	 ...
	 private ArrayList<DangKyHocPhan> dangKyHocPhan;
	 private ArrayList<LopMo> lopMo;
/*=================== CONSTRUCTORs ================================*/
	 public HocKyHeThong() {
	 ...
	 public HocKyHeThong(String maHocKyHeThong, Date batDauDangKyHocPhan, Date batDauDangKyLopMo, Date batDauHocKy, Date ketThucHocKy, ArrayList<DangKyHocPhan> dangKyHocPhan, ArrayList<LopMo> lopMo) {
...
/*=================== OTHER METHODs  ===============================*/
	 ...
	 public ArrayList<DangKyHocPhan> getDangKyHocPhan() {
		  return dangKyHocPhan;
	 }

	 public void setDangKyHocPhan(ArrayList<DangKyHocPhan> dangKyHocPhan) {
		  this.dangKyHocPhan = dangKyHocPhan;
	 }

	 public ArrayList<LopMo> getLopMo() {
		  return lopMo;
	 }

	 public void setLopMo(ArrayList<LopMo> lopMo) {
		  this.lopMo = lopMo;
	 }
